...
- ゲーム進行(牌山・配牌・ターン進行・流局)と CPU 対局 AI は Phase 2([docs/spec-phase2.md](./spec-phase2.md))で扱う。対戦画面から実際に CPU と対戦できるようにする要件は Phase 2 に定義する。
...
| 役判定(1〜13翻、役満) | ローカル役 |
| 符計算 | 流局処理・ゲーム進行(Phase 2: [docs/spec-phase2.md](./spec-phase2.md)) |
